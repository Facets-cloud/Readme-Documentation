...
<Image alt="Edit button in IaC Version widget (Click on the image to expand)" align="center" width="450px" src="https://files.readme.io/06f06b5-edit_iac_in_env.png">
...
<Image alt="Edit IaC Version popup window (Click on the image to expand)" align="center" width="450px" src="https://files.readme.io/d9a95ad-edit_iac_popup.png">
...
<Image alt="Success toaster (Click on the image to expand)" align="center" width="450px" src="https://files.readme.io/609c1f6-success_iac.png">
...
<Image alt="Click on the Releases button in the Navigation bar (Click on the image to expand)" align="center" width="450px" src="https://files.readme.io/e11e2c8-releases_page.png">
...
<Image alt="Update IaC Version button in other settings (Click on the image to expand)" align="center" width="450px" src="https://files.readme.io/b6185b3-update_iac_2.png">
...
<Image alt="Edit IaC Version popup window (Click on the image to expand)" align="center" width="450px" src="https://files.readme.io/539cdbc-update_iac_popup_2.png">
  Edit IaC Version popup window (Click on the image to expand)
</Image>

7. You should see a success toaster popup confirming your changes. 

<Image alt="Success toaster (Click on the image to expand)" align="center" width="450px" src="https://files.readme.io/5c96647-success_iac.png">
  Success toaster (Click on the image to expand)
</Image>
