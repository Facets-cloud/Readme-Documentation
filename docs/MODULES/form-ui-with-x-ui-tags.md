...
| **Dynamic Data Sources**        | [`x-ui-api-source`](https://readme.facets.cloud/docs/form-ui-with-x-ui-tags#x-ui-output-type)            | Populates dropdown options by calling a specified API endpoint and applies optional filters to retrieve and display relevant data based on the defined criteria.                   |
