...
next:
  description: ''
---
Time Sensitive Environments allow you to automatically schedule when your clusters launch/destroy and scale up/down. This helps optimise resource usage and reduce costs by running environments only when needed.
